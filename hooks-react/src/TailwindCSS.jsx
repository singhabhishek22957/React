...
function TailwindCSS() {
  return (
    <>
      <div className="bg-gray-500 font-mono text-center text-3xl text-white p-4">
        Hello Abhishek
      </div>
      ...
      <div class="flex font-sans">
        <div class="flex-none w-48 relative">
          <img
            src="https://img.freepik.com/premium-photo/portrait-smiling-boy-standing-railroad-track_1048944-467238.jpg?uid=R62087732&ga=GA1.1.220801396.1730532252&semt=ais_siglip"
            alt=""
